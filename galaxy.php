            ...
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Location:</strong>
                  <span>Chicago, IL 606543</span></li>
                ...
                <li><strong>Beds:</strong>
                  <span>3</span></li>
                <li> <strong>Baths:</strong>
                  <span>2</span></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Galaxy Apartments</h2>
              <p>
                Autem ipsum nam porro corporis rerum. Quis eos dolorem eos itaque inventore commodi labore quia quia. Exercitationem repudiandae officiis neque suscipit non officia eaque itaque enim. Voluptatem officia accusantium nesciunt est omnis tempora consectetur dignissimos. Sequi nulla at esse enim cum deserunt eius.
              </p>
              <!-- <a href="C:\Users\Dell\Desktop\project\EstateAgency\galaxy.php">...know more</a> -->
            </div>
          </div>
            ...
            <div class="row">
                  ...
                  <form class="form-a" action=""  method="post">
                    <div class="row">
                      ...
                      <div class="col-md-12 mt-3">
                        <button type="submit" class="btn btn-a" data-submit="...Sending" name="submit">Send Message</button>
              ...
              <div class="col-md-6 col-lg-4">
                ...
                <form action="" method="post" class="form-b">
                  <fieldset>
                    <!-- <legend><span class="number"></span>Book an Appointment</legend> -->
                    <label for="name">Name*:</label>
                    <input type="text" id="name" name="user_name" placeholder="" required pattern="[a-zA-Z0-9]+"><br><br>

                    <label for="mail">Email*:</label>
                    <input type="email" id="mail" name="user_email" placeholder="" required><br><br>

                    <label for="tel">Contact Number:</label>
                    <input type="tel" id="tel" placeholder="Include country code" name="user_num"><br><br>
                    ...
                    <button type="submit" class="btn btn-a">Request For Appointment</button>          
                 ...
                 <!-- php include 'server.php'?> --> 
                  <form action="" method="post" class="form-c" >
                    ...
                    <input type="text" id="name" name="visitor_name" placeholder="" pattern=[A-Z\sa-z]{3,20} required><br><br>
                    <label for="email">Your E-mail</label>
                    <input type="email" id="email" name="visitor_email" placeholder="" required><br><br>
                    <label for="phoneno">Phone Number</label>
                    <input type="text" id="phoneno" name="phonenumber"><br><br>                  
                    <label for="property-id">Property ID</label>
                    <input type="text" id="propid" name="propertyid"><br><br>  
                    <label for="adhaar-id">Adhaar Card Number</label>
                    <input type="text" id="adharid" name="adhaarid"><br><br>  <br>
                  </form>
                <button type="submit" class="btn btn-a" name="book-prop">Book Flat</button>          
              </div>
            </div>
